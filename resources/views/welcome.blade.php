        ...
        <div class="header-bottom"><!--header-bottom-->
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <form action="{{URL::to('/search-item')}}" method="post">
                            {{ csrf_field() }}
                            <div class="search_box pull-right">
                                <input type="text" name="key_words" placeholder="Search"/>
                                <input style="margin-top:0; color:#666" type="submit" name="search_items" class="btn btn-primary btn-sm" value="Search" />
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('public/Frontend/images/banner1.jpg')}}" class="girl img-responsive" alt="" />
                            ...
                            @foreach($category as $key => $cate)
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="{{URL::to('/catalog-product/'.$cate->category_id)}}">{{$cate->category_name}}</a></h4>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach($brand as $key => $brand)
                                        <li><a href="{{URL::to('/publisher/'.$brand->brand_id)}}"> <!-- <span class="pull-right">(50)</span> -->{{$brand->brand_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
